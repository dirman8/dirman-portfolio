...
const Form = () => {
  ...
  return (
		<div className="w-full  bg-gray-100 pt-24 pb-32 md:px-16">
			<div className="pb-4 text-center text-4xl font-medium text-gray-700 ">CONTACT</div>
			<div className="m-auto mb-8 bg-gray-700 h-1 w-20  "></div>
			<div className="flex justify-center w-full md:px-16">
				<form className="flex flex-col max-w-3xl w-full pb-5 bg-gray-100" onSubmit={onSubmit}>
