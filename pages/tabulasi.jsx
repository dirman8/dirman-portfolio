...
import { dapil1, dapil2, dapil3, dapil4, dapil5, provinsi, pusat } from "../constant/namaCaleg";

const NewTabulasi = () => {
    const [sum, setSum] = useState(0);
    const [getHasilTps, setgetHasilTps] = useState([]);
    console.log("getHasilTps :", getHasilTps)
    ...
    const fetchHasilTps = async () => {
      ...
      try {
        ...
        results.forEach(result => {
          total += results.DEMOKRAT1;
        });
        setSum(total)
        console.log("sum :", sum);
        // setgetHasilTps(result.data || []); // Assuming your API response has a 'data' property
      } catch (error) {
    ...
    <div className="flex flex-col w-full pl-0 md:p-4 md:space-y-4">
      ...
      <div className="h-screen pt-2 pb-24 pl-2 pr-2 overflow-auto md:pt-0 md:pr-0 md:pl-0">
        <div className="flex flex-col flex-wrap sm:flex-row ">
          ...
          {/* CARD 1 */}
          <Card caleg={dapil1} tingkat="Surabaya" dapil="1"/>
          <Card caleg={dapil2} tingkat="Surabaya" dapil="2"/>
          <Card caleg={dapil3} tingkat="Surabaya" dapil="3"/>
          <Card caleg={dapil4} tingkat="Surabaya" dapil="4"/>
          <Card caleg={dapil5} tingkat="Surabaya" dapil="5"/>
        </div>
        <div>
          <Card caleg={provinsi} tingkat="Provinsi Jawa Timur" dapil=""/>
          <Card caleg={pusat} tingkat="DPR RI" dapil=""/>
        </div>
      </div>
    </div>
  </div>
